...
#[ext_contract(ext_internal_methods)]
pub trait ExtInternalMethods {
...
#[ext_contract(ext_public_methods)]
pub trait ExtPiblicMethods {
...
pub struct Contract {
    ...
    subscriptions: LookupMap<AccountId, Vec<UserSubscription>>,
}
...
impl Contract {
    ...
    pub fn new(
        ...
        let mut this = Self {
            ...
            subscriptions: LookupMap::new(b"t"),
        };
