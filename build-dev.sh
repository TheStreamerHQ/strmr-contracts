...
near-cli add contract-code network custom --url http://localhost:3030/ account streamer.test.near contract-file ./res/thestreamer_contract.wasm initialize new '{"owner_id": "test.near", "total_supply": "100", "metadata": {"spec": "ft-1.0.0", "name": "Streamer", "symbol": "STRMR", "decimals": 0}}' --attached-deposit '0 NEAR' --prepaid-gas '200.000 TeraGas' sign-with-keychain send
